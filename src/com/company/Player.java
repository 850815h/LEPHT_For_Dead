...
public abstract class Player {
    ...
    public Player(String name, int savingAbility, int speed, int dribblingAbility, int breakingAbility, int passingAbility, String position, int shootingAbility, String teamName) {
        this.name = name;
